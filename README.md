...
- Dense HUD micro-details — hairlines, rails, corner ticks, bevels across chrome + reading surfaces
- Hard HUD interface motion — dock/snap overlays, press/hover physics, CTA signal scale (opt out via Style Settings)
